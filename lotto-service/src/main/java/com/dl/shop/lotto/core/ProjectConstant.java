package com.dl.shop.lotto.core;
...
public class ProjectConstant {
	public static final String BASE_PACKAGE = "com.dl.shop.lotto";//项目基础包名称，根据自己公司的项目修改
 ...
 // 福彩3D点数
	...
	/** 竞彩足球已选赛事列表 */
//	public static ArrayList<JczqSchema> JCZQ_Select_SHAMES = new ArrayList<JczqSchema>();
